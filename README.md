...
4. Line 18: i < 64 -> i < 128, There was aliasing around the spheres that usually occurs from having not enough samples, and the board was cut off too early. Therefore, locating the for loop that decides the ray step counts and increasing it by 2 fixed the problem.
